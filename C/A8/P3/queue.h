 ...
 * @brief Prints queue
 * 
 * Prints the queue by going through the queue with the help of a 
 * cursor variable.
 * As long as the cursor isn't at NULL(end of queue) it will print whatever item is
 * in the cursor
 * @param item The item that is being looked at with the cursor that will be printed
 */
